<div class="modal fade" id="deleteUserProprietaire" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data" action="<?php getenv("URL_APP")?>/src/controllers/utilisateurs/proprietaire/delete.php">
