...
<div id="bloc_step_5" class="unshow_step mb-3">
    ...
    <div class="col-md-12 d-flex" id="penom_particulier_recap">
    ...
    <div class="d-flex flex-wrap" role="group" aria-label="Basic checkbox toggle button group" id="alimentaire_recap">
    ...
    <div class="d-flex flex-wrap" role="group" aria-label="Basic checkbox toggle button group" id="centre_interet_recap">
