...
// let btn2 = document.querySelector('#centres_interets');
...
//     xmlhttp.send();
// })
// let btn3 = document.querySelector('#personnalite');
...
//     xmlhttp.send();
// })
// let btn4 = document.querySelector('#style_vie');
//     btn4.addEventListener("change", (e) => {
//     var xmlhttp = new XMLHttpRequest();
//     xmlhttp.onreadystatechange = function() {
//         if (this.readyState == 4 && this.status == 200) {
//             console.log('');
